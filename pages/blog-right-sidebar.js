                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="pagination-area">
                                        <div className="nav-links">
                                            <a href="/blog-right-sidebar" className="page-numbers current">1</a>
                                            <a href="/blog-right-sidebar" className="page-numbers">2</a>
                                            <a href="/blog-right-sidebar" className="page-numbers">3</a>
                                            <a href="/blog-right-sidebar" className="next page-numbers" title="Next Page">
